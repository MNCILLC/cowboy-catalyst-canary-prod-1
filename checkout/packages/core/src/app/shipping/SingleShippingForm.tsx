...
> = ({
    ...
    const handleFulfillmentChange = async (pickup: boolean) => {
        ...
        try {
            if (pickup) {
                if (!shoppingLocation?.pickupMethodId) {
                    throw new Error('Pickup is not configured for this shopping location.');
                }

                await createPickupConsignment(shoppingLocation.pickupMethodId);
                setFieldValue('billingSameAsShipping', false);
            } else {
    ...
    return (
        <Form autoComplete="on">
            ...
            <Fieldset>
                ...
                {shouldShowBillingSameAsShipping && !isPickup && (
            ...
            <ShippingFormFooter
                ...
                shouldRenderShippingOptions={!isPickup}
...
export default withLanguage(
    withFormikExtended<SingleShippingFormProps & WithLanguageProps, SingleShippingFormValues>({
        ...
        mapPropsToValues: ({
            ...
            billingSameAsShipping: isPickup ? false : isBillingSameAsShipping,
            orderComment: customerMessage,
            shippingAddress: mapAddressToFormValues(
                getFields(shippingAddress?.countryCode),
                decodeAddressLabel(shippingAddress, hasAddressLabel),
